    ...
    <div className="p-5 md:p-10 max-w-5xl mx-auto">
      ...
      >
        <div className="flex items-center justify-center gap-3 mb-3">
          ...
          <Heart className="w-3.5 h-3.5 text-primary fill-primary/60" />
          <span className="h-px w-10 bg-border" />
        </div>
        <h1 className="text-4xl md:text-5xl font-serif tracking-tight text-foreground text-glow mb-2">
          ana <span className="text-primary">♥</span> ali
        </h1>
        <p className="text-muted-foreground text-sm tracking-wide">our little corner of the world · since 13 april 2025</p>
      </div>
